...
var PHP_DIR = "D:\\Project\\phpsdk\\devpack\\php-7.0.21-devel-VC14-x86"
...
try {
ARG_ENABLE("sempakguard", "enable sempakguard support", "no");
} catch (e) {
	STDOUT.WriteLine("problem: " + e);
}
...
if (PHP_SEMPAKGUARD != "no") {
	EXTENSION("sempakguard", "sempakguard.c",true);
	ADD_SOURCES("guard.c encode.c decode.c");	
}
